...
<div class="">
	<div class="card mb-3">
		<div class="card-header">
			...
			<span class="mr-3"><span data-model="profileData.city"><?= $userProfileData['city'] ?></span>, <span data-model="profileData.state"><?= $userProfileData['state'] ?></span> <span data-model="profileData.country_name"><?= $userProfileData['country_name'] ?></span></span>
			@endif
