...
<head>
    ...
    <?= __yesset(['dist/css/public-assets-app*.css', 'dist/fa/css/all.min.css', 'dist/css/home*.css'], true) ?>
    <?= __yesset(['dist/css/light-theme*.css'], true) ?>
    ...
    <header class="masthead">
        <div class="container d-flex h-100 align-items-center pt-5">
            ...
            '__siteName__' => getStoreSettings('name'),
                ...
                <p class="mt-5 pt-5 text-white-50">
                    <?= __tr('You can modify the content on this page by editing outer home page view.') ?></p>
            </div>
        </div>
    </header>
    </div>
