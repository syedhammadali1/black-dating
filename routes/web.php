...
Route::group([
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::group([
            ...
            Route::get('/term-conditions', [
                'as' => 'term-conditions',
                'uses' => 'HomeController@term_conditions'
            ]);

            Route::get('/login', [
                'as' => 'landing_page',
                'uses' => 'HomeController@landingLoginPage'
            ]);
    ...
    Route::get('/user/form', [
        'as' => 'user.form',
        'uses' => 'Home\Controllers\HomeController@step_form'
    ]);

    Route::post('/user/form/submit', [
        'as' => 'user.form.submit',
        'uses' => 'Home\Controllers\HomeController@step_form_save'
    ]);
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('/pro', [
            'as' => 'payment',
            'uses' => 'Home\Controllers\HomeController@payment'
        ]);


        Route::post('/stripe', [
            'as' => 'stripe.post',
            'uses' => 'Home\Controllers\HomeController@stripePost'
        ]);
